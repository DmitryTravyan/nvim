...
function M.setup(name)
    if ('string' == type(name)) then
        ...
        M.colors = {
            base00 = '0', base01 = '1', base02 = '2', base03 = '3',
            base04 = '4', base05 = '5', base06 = '6', base07 = '7',
            base08 = '8', base09 = '9', base0A = '10', base0B = '11',
            base0C = '12', base0D = '13', base0E = '14', base0F = '15',
        }
    end
    ...
    if M.config.airline then
        hi.airline_x_inactive                        = { ctermfg = M.colors.base03, ctermbg = M.colors.base02,
            cterm = nil }
        hi.airline_x_inactive_bold                   = { ctermfg = M.colors.base03, ctermbg = M.colors.base02,
            cterm = 'bold' }
        hi.airline_x_inactive_red                    = { ctermfg = M.colors.base08, ctermbg = M.colors.base02, cterm = nil }
        hi.airline_y_inactive                        = { ctermfg = M.colors.base03, ctermbg = M.colors.base02,
            cterm = nil }
        hi.airline_y_inactive_bold                   = { ctermfg = M.colors.base03, ctermbg = M.colors.base02,
            cterm = 'bold' }
        hi.airline_y_inactive_red                    = { ctermfg = M.colors.base08, ctermbg = M.colors.base02, cterm = nil }
        hi.airline_z_inactive                        = { ctermfg = M.colors.base01, ctermbg = M.colors.base03,
            cterm = nil }
        hi.airline_z_inactive_bold                   = { ctermfg = M.colors.base01, ctermbg = M.colors.base03,
            cterm = 'bold' }
        ...
        hi.airline_term_inactive_bold                = { ctermfg = M.colors.base0B, ctermbg = M.colors.base00,
            cterm = 'bold' }
        ...
        hi.airline_error_inactive_bold               = { ctermfg = M.colors.base00, ctermbg = 160,
            cterm = 'bold' }
        hi.airline_error_inactive_red                = { ctermfg = M.colors.base08, ctermbg = 160, cterm = nil }
        hi.airline_a_inactive                        = { ctermfg = M.colors.base01, ctermbg = M.colors.base03,
            cterm = nil }
        hi.airline_a_inactive_bold                   = { ctermfg = M.colors.base01, ctermbg = M.colors.base03,
            cterm = 'bold' }
        hi.airline_a_inactive_red                    = { ctermfg = M.colors.base08, ctermbg = M.colors.base03, cterm = nil }
        hi.airline_b_inactive                        = { ctermfg = M.colors.base03, ctermbg = M.colors.base02,
            cterm = nil }
        hi.airline_b_inactive_bold                   = { ctermfg = M.colors.base03, ctermbg = M.colors.base02,
            cterm = 'bold' }
        hi.airline_b_inactive_red                    = { ctermfg = M.colors.base08, ctermbg = M.colors.base02, cterm = nil }
        hi.airline_c_inactive                        = { ctermfg = M.colors.base03, ctermbg = M.colors.base02,
            cterm = nil }
        hi.airline_c_inactive_bold                   = { ctermfg = M.colors.base03, ctermbg = M.colors.base02,
            cterm = 'bold' }
        ...
        hi.airline_warning_inactive_bold             = { ctermfg = M.colors.base00, ctermbg = 166,
            cterm = 'bold' }
        ...
        hi.airline_x_bold                            = { ctermfg = M.colors.base0C, ctermbg = M.colors.base01,
            cterm = 'bold' }
        hi.airline_x_red                             = { ctermfg = M.colors.base08, ctermbg = M.colors.base01, cterm = nil }
        hi.airline_y                                 = { ctermfg = M.colors.base03, ctermbg = M.colors.base02,
            cterm = nil }
        hi.airline_y_bold                            = { ctermfg = M.colors.base03, ctermbg = M.colors.base02,
            cterm = 'bold' }
        ...
        hi.airline_z_bold                            = { ctermfg = M.colors.base01, ctermbg = M.colors.base0C,
            cterm = 'bold' }
        ...
        hi.airline_term_bold                         = { ctermfg = M.colors.base0B, ctermbg = M.colors.base00,
            cterm = 'bold' }
        ...
        hi.airline_error_bold                        = { ctermfg = M.colors.base01, ctermbg = M.colors.base08,
            cterm = 'bold' }
        ...
        hi.airline_a_bold                            = { ctermfg = M.colors.base01, ctermbg = M.colors.base0C,
            cterm = 'bold' }
        hi.airline_a_red                             = { ctermfg = M.colors.base08, ctermbg = M.colors.base0C, cterm = nil }
        hi.airline_b                                 = { ctermfg = M.colors.base03, ctermbg = M.colors.base02,
            cterm = nil }
        hi.airline_b_bold                            = { ctermfg = M.colors.base03, ctermbg = M.colors.base02,
            cterm = 'bold' }
        ...
        hi.airline_c_bold                            = { ctermfg = M.colors.base0C, ctermbg = M.colors.base01,
            cterm = 'bold' }
        ...
        hi.airline_warning_bold                      = { ctermfg = M.colors.base01, ctermbg = M.colors.base0A,
            cterm = 'bold' }
        ...
        hi.airline_b_to_airline_c                    = { ctermfg = M.colors.base02, ctermbg = M.colors.base01,
            cterm = nil }
        hi.airline_c_to_airline_x                    = { ctermfg = M.colors.base01, ctermbg = 236, cterm = nil }
        hi.airline_x_to_airline_y                    = { ctermfg = M.colors.base02, ctermbg = M.colors.base01,
            cterm = nil }
        ...
        hi.airline_c1_inactive                       = { ctermfg = M.colors.base03, ctermbg = M.colors.base02,
            cterm = nil }
        hi.airline_c1_to_airline_x                   = { ctermfg = M.colors.base01, ctermbg = M.colors.base00,
            cterm = nil }
        hi.airline_c3_inactive                       = { ctermfg = M.colors.base03, ctermbg = M.colors.base02,
            cterm = nil }
        hi.airline_c1_inactive_bold                  = { ctermfg = M.colors.base03, ctermbg = M.colors.base02,
            cterm = 'bold' }
        hi.airline_c1_inactive_red                   = { ctermfg = M.colors.base08, ctermbg = M.colors.base02, cterm = nil }
        hi.airline_x_to_airline_y_inactive           = { ctermfg = M.colors.base02, ctermbg = M.colors.base02,
            cterm = nil }
        hi.airline_z_to_airline_warning_inactive     = { ctermfg = 166, ctermbg = M.colors.base03, cterm = nil }
        hi.airline_c1_to_airline_x_inactive          = { ctermfg = M.colors.base02, ctermbg = M.colors.base02,
            cterm = nil }
        hi.airline_c_to_airline_x_inactive           = { ctermfg = M.colors.base02, ctermbg = M.colors.base02,
            cterm = nil }
        hi.airline_a_to_airline_b_inactive           = { ctermfg = M.colors.base03, ctermbg = M.colors.base02,
            cterm = nil }
        hi.airline_warning_to_airline_error_inactive = { ctermfg = 160, ctermbg = 166, cterm = nil }
        hi.airline_y_to_airline_z_inactive           = { ctermfg = M.colors.base03, ctermbg = M.colors.base02,
            cterm = nil }
        hi.airline_b_to_airline_c_inactive           = { ctermfg = M.colors.base02, ctermbg = M.colors.base02,
            cterm = nil }
        hi.airline_c3_to_airline_x                   = { ctermfg = M.colors.base01, ctermbg = M.colors.base00,
            cterm = nil }
    end
